...
public class Utils {
    ...
    public static Bitmap topBottomEdgeCrop(Bitmap img, float cropAmount) {
        return Bitmap.createBitmap(img,
                (int) (img.getWidth() * cropAmount), (int) (img.getHeight() * cropAmount),
                (int) (img.getWidth() * (1 - cropAmount*2)), (int) (img.getHeight() * (1 - cropAmount*2)));
    }

    public static Bitmap centerCrop(Bitmap img) {
